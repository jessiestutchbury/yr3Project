...
//getOrderQuantity
		...
		txtAddStock.setFont(new Font("Tahoma", Font.BOLD, 15));
		txtAddStock.setEditable(false);
		txtAddStock.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
